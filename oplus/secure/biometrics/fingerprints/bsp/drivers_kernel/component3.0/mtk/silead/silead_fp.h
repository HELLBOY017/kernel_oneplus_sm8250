...
struct fp_dev_kmap_t {
	uint16_t k[NAV_KEY_MAX -
			    NAV_KEY_START]; /* Up/Down/Right/Left/Click/Double Click/Longpress */
};
...
#define SIFP_IOC_GET_TP_TOUCH_INFO          _IOR(SIFP_IOC_MAGIC, 31, struct fp_dev_touch_info)
