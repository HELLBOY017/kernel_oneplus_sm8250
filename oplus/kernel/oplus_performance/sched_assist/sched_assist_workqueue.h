...
static inline bool is_uxwork(struct work_struct *work) { return false; }
static inline bool set_uxwork(struct work_struct *work) { return false; }
static inline bool unset_uxwork(struct work_struct *work) { return false; }
