...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(5, 10, 0))
const struct file_operations proc_task_track_operations = {
...
const struct file_operations proc_task_track_enable_operations = {
...
static const struct file_operations proc_sched_latency_operations = {
	.open = proc_sched_latency_open,
	.read = seq_read,
	.llseek = seq_lseek,
	.release = single_release,
};

static const struct file_operations proc_sched_iowait_operations = {
	.open = proc_sched_iowait_open,
	.read = seq_read,
	.llseek = seq_lseek,
	.release = single_release,
};
...
static const struct file_operations proc_ux_throttle_operations = {
	.open = proc_ux_throttle_open,
	.read = seq_read,
	.llseek = seq_lseek,
	.release = single_release,
};
